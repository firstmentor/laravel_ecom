                      ...
                      <div class="table-responsive">
                        <table class="shop-cart-table">
                          ...
                          <tbody>
                            ...
                            <tr class="cart_item">
                              <td class="item-img"><a href="#"><img src="{{asset('/upload/product/'.$cartdata->image)}}" alt="Product tilte is here "> </a></td>
                                  ...
                                  <div class="product-qty">
                                    <div class="cart-quantity">
                                      <div class="cart-plus-minus">
                                        ...
                                        <input  name="quantity" class="cart-plus-minus-box" type="text" value="{{$cartdata->quantity}}">
